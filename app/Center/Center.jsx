        ...
        <div className='w-[80%]  mx-auto flex justify-around items-center py-4 '>
             <div className='grid grid-cols-12  '>
                <div className='col-span-6 '>
                    ...
                    <p className='w-120 my-5 '>أطلق موقعك للتجارة الإلكترونية، وتطبيق الهاتف، ولوحة التحكم القوية  جميعها في باقة واحدة . قم بإدارة مبيعاتك، ومتابعة الأداء، وتنمية عملك بسهولة تامة.</p>
