  ...
  return (
     <section className='py-5 mt-2 bg-[#F9F8FE] '>
      <header className=''>
        ...
        <div className='my-5 text-center'>      <button type="button" className="text-white bg-[#537FE7] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm px-8 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-pointer"> جرب الان مجاناً </button>
</div>
